...
## Randomness for igraph R package $\ge$ 1.3

For the igraph R package after version 1.3, the Louvain method is no longer 
deterministic as reported in 
[its Github #539 issue](https://github.com/igraph/rigraph/issues/539).
