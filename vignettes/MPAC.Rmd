...
# CN state matrix from `ppCnInp()`
cn_state_mat  = system.file('extdata/pltNeiStt/inp_focal.rds',       
                            package='MPAC') %>% readRDS()

# RNA state matrix from `ppRnaInp()`
rna_state_mat = system.file('extdata/pltNeiStt/inp_log10fpkmP1.rds', 
                            package='MPAC') %>% readRDS()

# filtered IPL matrix from `fltByPerm()`
fltmat= system.file('extdata/pltNeiStt/fltmat.rds',          
                    package='MPAC') %>% readRDS()
